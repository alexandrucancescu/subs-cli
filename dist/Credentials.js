...
const ACC_FILE = path_1.join(__dirname, "../account");
function getCredentials() {
    return __awaiter(this, void 0, void 0, function* () {
        let accounts = yield keytar.findCredentials("opensubtitles.org");
        const credentials = yield getCredentialsRec(accounts);
...
function getCredentialsRec(accounts, triedAccounts = [], firstPass = true) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (yield tryCredentials(credentials)) {
            return credentials;
        }
        else {
...
function tryCredentials(credentials) {
    return __awaiter(this, void 0, void 0, function* () {
        const spinner = ora(`Logging in ${credentials.account}`).start();
        try {
...
function inquireAccount(accounts) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return _a = accounts.find(acc => acc.account === accountName.account), (_a !== null && _a !== void 0 ? _a : null);
    });
}
